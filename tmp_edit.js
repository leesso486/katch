...
const newCss = `
        ...
        .s-sec-h a { font-size: 13px; color: #2563eb; font-weight: 700; text-decoration: none; text-align:right;}
        ...
        .s-btn { padding: 8px 16px; border-radius: 20px; font-size: 13px; font-weight: 800; border: none; cursor: pointer; transition: 0.2s; white-space: nowrap; margin-left: 15px;}
        ...
        .s-chart-txt { background: #f8fafc; padding: 14px; border-radius: 8px; font-size: 13px; color: #64748b; line-height: 1.5; font-weight: 600; text-align: center; word-break: keep-all; }
...
content = content.replace(/\\/\\*\\s*Student Dashboard Gamification Styling\\s*\\*\\/[\\s\\S]*?(?=\\/\\*\\s*Teacher CRM Dashboard Styling\\s*\\*\\/)/, newCss);
...
const newHtml = \`
        ...
        <div id="studentView">
            <div class="student-layout">
                ...
                <main class="s-main">
                    <div class="s-top">
                        <div class="s-breadcrumb">Main <i class="fas fa-chevron-right" style="font-size:10px; margin:0 5px; color:#cbd5e1;"></i> <span>Dashboard</span></div>
                        <div class="s-status">
                            <div class="s-badge" style="color: #ea580c;"><i class="fas fa-fire"></i> 5일 연속</div>
                            <div class="s-badge" style="color: #d97706;"><i class="fas fa-coins" style="color:#f59e0b;"></i> 12,450 P</div>
                            <img src="https://ui-avatars.com/api/?name=Jihoon&background=eff6ff&color=2563eb" alt="Avatar" class="s-avatar">
                        </div>
                    </div>
                    ...
                    <div class="s-grid">
                        <div>
                            ...
                            <div style="margin-bottom: 24px;">
                                ...
                                <div class="s-task">
                                    <div class="s-ticon" style="background: #f0fdf4; color: #10b981;"><i class="fas fa-font"></i></div>
                                    <div style="flex-grow:1;">
                                    ...
                                    <button class="s-btn sb-green" onclick="location.href='#TargetBank'">학습 시작</button>
                                </div>
                            </div>
                                ...
                                <table class="s-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="color:#64748b; font-weight:600;">2023.10.24</td>
                                            <td style="color:#2563eb;">95/100</td>
                                            <td><div class="schip sc-g">합격</div></td>
                                        </tr>
                                        <tr>
                                            <td>GVR 문법 성취도 평가</td>
                                            <td style="color:#64748b; font-weight:600;">2023.10.22</td>
                                            <td style="color:#2563eb;">82/100</td>
                                            <td><div class="schip sc-g">합격</div></td>
                                        </tr>
                                        <tr>
                                            <td>Mid-Term Mock Test</td>
                                            <td style="color:#64748b; font-weight:600;">2023.10.15</td>
                        ...
                        <div>
                            <!-- Radar Chart -->
                            <div class="s-card" style="margin-bottom: 24px; background:#eff6ff;">
                                <h2 style="font-size:16px; font-weight:900; color:#1e293b; margin:0 0 16px 0;">학습 역량 분석</h2>
                                <div class="s-chart-box" style="background:transparent; padding:0; height:240px; margin-bottom:15px;">
                                    <canvas id="studentRadarChart"></canvas>
                                </div>
                                <div class="s-chart-txt" style="background:#e0e7ff; color:#3b82f6;">
                                    <strong style="color:#1d4ed8;">문법</strong> 영역이 지난주 대비 <strong style="color:#15803d;">12%</strong> 상승했습니다! 독해 영역 보충이 필요해 보입니다.
                                </div>
                            </div>

                            <!-- Timeline -->
                            <div class="s-card" style="padding-bottom:15px;">
                                <h2 style="font-size:16px; font-weight:900; color:#1e293b; margin:0 0 6px 0;">최근 활동 & 포인트</h2>
                                <div class="s-alist">
                                    <div class="s-aitem">
                                        <div class="sa-icon" style="color:#ea580c; border-color:#fed7aa; background:#fff7ed;"><i class="fas fa-calendar-check"></i></div>
                                        <div><div class="sa-title">일일 출석 체크</div><div class="sa-time">오늘 09:12</div></div>
                                        <div class="sa-pts" style="color:#16a34a;">+100 P</div>
                                    </div>
                                    <div class="s-aitem">
                                        <div class="sa-icon" style="color:#2563eb; border-color:#bfdbfe; background:#eff6ff;"><i class="fas fa-check-double"></i></div>
                                        <div><div class="sa-title">GVR Chapter 4 완료</div><div class="sa-time">어제 21:45</div></div>
                                        <div class="sa-pts" style="color:#16a34a;">+500 P</div>
                                    </div>
                                    <div class="s-aitem">
                                        <div class="sa-icon" style="color:#d97706; border-color:#fde68a; background:#fffbeb;"><i class="fas fa-trophy"></i></div>
                                        <div><div class="sa-title">어휘 테스트 만점 보상</div><div class="sa-time">2023.10.24</div></div>
                                        <div class="sa-pts" style="color:#16a34a;">+1,000 P</div>
                                    </div>
                                    <div class="s-aitem" style="border:none; padding-bottom:0;">
                                        <div class="sa-icon" style="color:#64748b; border-color:#e2e8f0; background:#f8fafc;"><i class="fas fa-shopping-bag"></i></div>
                                        <div><div class="sa-title">편의점 5천원권 교환</div><div class="sa-time">2023.10.20</div></div>
                                        <div class="sa-pts" style="color:#ef4444;">-5,000 P</div>
                                    </div>
                                </div>
                                <button class="s-btn sb-white" style="width:100%; margin:20px 0 0 0; padding:12px; font-weight:700;">포인트 내역 더보기</button>
                            </div>
                        </div>
                    </div>
                </main>
...
content = content.replace(/<div id="studentView">[\\s\\S]*?<\\/div>\\s*(?=<div id="teacherView">)/, newHtml + '\\n        ');

// 3. Replace Chart Logic
const oldChartLogicRegex = /radarChartInstance\\s*=\\s*new Chart\\(ctx, [\\s\\S]+?\\}\\);/;
const newChartLogic = \`
            radarChartInstance = new Chart(ctx, {
                type: 'radar',
                data: { labels: ['어휘', '문법', '독해', '청해', '모의고사'], datasets: [{ label: '나의 성취도', data: [82, 85, 68, 90, 75], backgroundColor: 'rgba(37, 99, 235, 0.2)', borderColor: '#2563eb', borderWidth: 2, pointBackgroundColor: '#2563eb' }, { label: '반 평균', data: [75, 80, 75, 85, 68], backgroundColor: 'transparent', borderColor: '#94a3b8', borderWidth: 2, borderDash: [5,5], pointBackgroundColor: '#94a3b8' }] },
                options: { responsive: true, maintainAspectRatio: false, scales: { r: { angleLines: { color: '#bfdbfe' }, grid: { color: '#bfdbfe', circular: true }, pointLabels: { font: { size: 12, weight: 800 }, color: '#1e293b' }, ticks: { display: false, min: 0, max: 100, stepSize: 20 } } }, plugins: { legend: { display: false } } }
            });
\`;

content = content.replace(oldChartLogicRegex, newChartLogic);
