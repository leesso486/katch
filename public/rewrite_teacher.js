...
let text = fs.readFileSync('teacher_dashboard.html', 'utf-8');

const targetStr = '<div id="teacherView">';
const idx = text.indexOf(targetStr);

if (idx === -1) {
    console.log('Could not find teacherView');
    process.exit(1);
}

const pre_text = text.substring(0, idx);

const new_teacher_ui = `
        <style>
            ...
            .tw-card { background: white; border-radius: 16px; padding: 22px; border: 1px solid #e2e8f0; box-shadow: 0 4px 20px rgba(0,0,0,0.03); flex-shrink: 0; }
            ...
            .tw-select { width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 13px; font-family: inherit; color: #334155; font-weight: 600; outline: none; }
            ...
            .tw-btn.outline { background: white; color: #64748b; border: 1px solid #e2e8f0; }
            .tw-btn.outline:hover { border-color: #94a3b8; color: #1e293b; }
        ...
        <div id="teacherView" class="tw-layout" style="display:none;">
            <!-- LEFT PANEL -->
            <div class="tw-left">
                        ...
                        <div style="margin-top:20px; flex-grow:1; display:flex; flex-direction:column;">
                            ...
                            <div class="tw-timeline" style="flex-grow:1; max-height:200px; overflow-y:auto;">
                                ...
                                <div class="tw-tl-item" style="margin-bottom:0;">
                                    ...
                                    <div class="tw-tl-content">주간 GVR 리뷰 리포트 카카오톡 발송 성공</div>
                                </div>
                            </div>
                        </div>
...
fs.writeFileSync('teacher_dashboard.html', pre_text + new_teacher_ui, 'utf-8');
console.log('Successfully updated teacher_dashboard.html');
