const fs = require('fs');
const target_file = "c:\\Users\\SsoHot\\Desktop\\수능사이트시안\\katch-web\\public\\dashboard.html";
...
const linesToKeepStart = lines.slice(0, 207);
const linesToKeepEnd = lines.slice(791);
const finalContent = linesToKeepStart.join('\\n') + '\\n' + new_ui + '\\n' + linesToKeepEnd.join('\\n');
